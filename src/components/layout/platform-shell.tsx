...
export function PlatformShell({ children }: { children: ReactNode }) {
  ...
  const sidebar = (
    <aside className="flex h-full flex-col gap-8 border-r border-border/25 bg-background/90 p-6 backdrop-blur-xl">
      ...
      <nav className="grid gap-8" aria-label="Platform navigation">
      ...
      <div className="mt-auto rounded-lg bg-secondary/20 p-4">
